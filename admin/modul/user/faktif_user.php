								...
								<div class="card-body">
									<div class="account-settings">
										<div class="user-profile">
                                            ...
                                            <form action="modul/user/activate_user.php" method="post" name="fedit">
                                            <div class="row gutters">
										<div class="col-12">
                                        <center>
                                        <input name="hf_id" type="hidden" id="hf_id" value="<?php echo $row['id_']; ?>" />

											<button type="submit" id="submit" name="submit" class="btn btn-primary" style="background-color:#093;">Activate Account</button>
                                            </center>
