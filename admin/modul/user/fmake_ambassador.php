								...
								<div class="card-body">
									<div class="account-settings">
										<div class="user-profile">
                                            ...
                                            <form action="modul/user/ed_make_ambassador.php" method="post" name="fedit">
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="text-center">
												...
												<button type="submit" id="submit" name="submit" class="btn btn-primary">Make Ambassador</button>
											</div>
										</div>
									</div>
                                            </form>
