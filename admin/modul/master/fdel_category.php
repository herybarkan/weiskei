								...
								<div class="card-body">
									<div class="account-settings">
										<div class="user-profile">
                                            ...
                                            <br>
											<h5 class="user-name"><?php echo $row['nm_category']; ?> 
												</h5>
                                            ...
                                            <form action="modul/master/del_category.php" method="post" name="fedit">
                                            <div class="row gutters">
										<div class="col-12">
                                        <center>
                                        <input name="hf_id" type="hidden" id="hf_id" value="<?php echo $row['id_']; ?>" />

											<button type="submit" id="submit" name="submit" class="btn btn-primary" style="background-color:#F00;">Delete Category</button>
                                            </center>
