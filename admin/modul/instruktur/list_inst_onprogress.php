...
<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="table-container">
								<div class="t-header">
                                <h4>List My Accepted Booking</h4>
								...
								<div class="table-responsive">
									<table width="100%" class="table custom-tablex" id="basicExamplex">
                                        ...
                                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM payments WHERE product_name LIKE '%$_SESSION[yo_kd_user]%' AND approve='1' ORDER BY id DESC");	//sql select query
									$select_stmt->execute();
...
ON user_.kd_user = member.kd_member
   ...
   $row_mem=$select_mem->fetch(PDO::FETCH_ASSOC);
                    ...
                    <?php if ($row['approve']=="1" && $row['sts_end']=="0") { ?>                          
                    <a href="javascript:void(0);" class="openPopup" data-href="modul/instruktur/done_order.php?id_=<?php echo $row['id']; ?>" id="xxx">
                    <img src="img/new_order.png" width="41" height="40" />
                    </a>
                    <?php }  elseif ($row['approve']=="1" && $row['sts_end']=="1") { ?>                          
                    <a href="javascript:void(0);" class="openPopup" data-href="modul/member/done_order.php?id_=<?php echo $row['id']; ?>" id="xxx">
                    ...
                    <?php } ?>
											  ...
											  <td align="center"><img src="../foto/user/<?php echo $row_mem['photo']; ?>"  height="60" /></td>
												<td>
												<strong>
												<?php echo $row_mem['first_name'].' '.$row_mem['last_name']; ?> </strong><br><?php echo $row_mem['nm_negara'].','.$row_mem['nm_state'].','.$row_mem['nm_city']; ?>
