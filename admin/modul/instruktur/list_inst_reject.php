							...
							<div class="table-container">
								...
								<div class="table-responsive">
									<table width="100%" class="table custom-tablex" id="basicExamplex">
                                        ...
                                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM payments WHERE product_name LIKE '%$_SESSION[yo_kd_user]%' AND approve='9' ORDER BY id DESC");	//sql select query
									$select_stmt->execute();
   ...
   $row_mem=$select_mem->fetch(PDO::FETCH_ASSOC);
                    ...
                    <img src="img/reject.png" width="41" height="40" />
											  ...
											  <td align="center"><img src="../foto/user/<?php echo $row_mem['photo']; ?>"  height="60" /></td>
												<td><strong><?php echo $row_mem['first_name'].' '.$row_mem['last_name']; ?></strong><br> 
