...
<form action="modul/instruktur/in_end_session.php" method="POST" enctype="multipart/form-data" style="width:100%;">
<div class="col-12">
							<h4>Booking Order
                            ...
                            <hr>
                                    ...
                                    <center>
                                    <h4><span style="color:#0C3;">SESSION OVER</span></h4>
                                    </center>
                                    </div>
                                   ...
                                   <div id="dapprove" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"> 
                                    ...
                                    <textarea name="notess" rows="4" style="width:100%;" required="required"></textarea>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <center>
                                    <button type="submit" class="btn btn-primary mb-2">Submit End Session</button>
                                    </center>
                                    </div>
                                    </div>
                                    </div>
