							...
							<div class="table-container">
								...
								<div class="table-responsive">
									<table width="100%" class="table custom-tablex" id="basicExamplex">
                                        ...
                                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM payments WHERE product_name LIKE '%$_SESSION[yo_kd_user]%' AND approve='3' ORDER BY id DESC");	//sql select query
									$select_stmt->execute();
   ...
   $row_mem=$select_mem->fetch(PDO::FETCH_ASSOC);
									...
									?>
											<tr>
											  <td><?php echo $x; ?></td>
											  <td align="center">
                                              <a href="javascript:void(0);" class="openPopup" data-href="modul/instruktur/info_donei.php?id_=<?php echo $row['id']; ?>" id="xxx">
                    <img src="img/done.png" width="41" height="40" />
                    </a>
                                              </td>
											  <td align="center"><img src="../foto/user/<?php echo $row_mem['photo']; ?>"  height="60" /></td>
												<td>
												<strong><?php echo $row_mem['first_name'].' '.$row_mem['last_name']; ?> </strong>
												<br>
