...
<div class="col-12">
						<h4>Update Banner Promo</h4>
                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM banner_promo WHERE aktif='1'");	//sql select query
									$select_stmt->execute();
                        ...
                        <div class="card" style="width:100%;">
								<div class="card-body">
									...
									<div class="row gutters">
										...
										<div class="col-12">
									    <img src="../imager/banner/<?php echo $row['image']; ?>" width="100%" /> 
                                        </div>
