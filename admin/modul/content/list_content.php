...
<div class="col-12">
                        ...
                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM content WHERE aktif='1'");	//sql select query
									$select_stmt->execute();
                        ...
                        <div class="card" style="width:100%;">
								<div class="card-body">
									...
									<div class="row gutters">
										...
										<div class="col-6">
									    <img src="../imager/home/<?php echo $row['image']; ?>" width="100%" /> 
                                        </div>
                                        ...
                                        <div class="col-6">
											<div class="form-group">
                                                ...
                                                <textarea name="textarea" rows="7" class="form-control"><?php echo $row['isi']; ?>
                                                </textarea>
											</div>
										</div>
