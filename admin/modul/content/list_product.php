...
<div class="col-12">
                        ...
                        <?php
										$x=1;
									$select_stmt=$db->prepare("SELECT * FROM product WHERE aktif='1'");	//sql select query
									$select_stmt->execute();
                        ...
                        <div class="card" style="width:100%;">
								<div class="card-body">
									...
									<div class="row gutters">
										...
										<div class="col-4">
									    <img src="../imager/product/<?php echo $row['image']; ?>" width="100%" /> 
                                        </div>
                                        <div class="col-8">
									    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                        <label for="inputEmail">Jenis Produk</label>
                                        <input name="link" type="text" class="form-control" id="link" placeholder="">
                                        </div>
                                        ...
                                        <textarea name="link" rows="7" class="form-control" id="link" placeholder=""></textarea>
                                        </div>
