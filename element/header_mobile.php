<div class="header">
    ...
    <div class="container-fluid">
        ...
        <div class="menu-mobile">
            <ul>
                <li><a href="index.php" class="menu-active">home</a><!--<span
                ...
                <li><a href="?com=new_arrivals">New Arrivals</a><!--<span class="lnr lnr-chevron-down drop-link"></span>-->
                    <!--<ul class="drop-menu">
                ...
                <li><a href="#">Product</a><span class="lnr lnr-chevron-down drop-link"></span>
                    <ul class="drop-menu">
                ...
                <li><a href="?com=about_us">About Us</a><!--<span class="lnr lnr-chevron-down drop-link"></span>-->
                    <!--<ul class="drop-menu">
                ...
                <li><a href="?com=contact">contact</a></li>
            </ul>
        </div>
    </div>
</div>